...
## Next Steps:
- [ ] Move authentication management out of containers and into screen
- [ ] Verify authentication with express server for isomorphic rendering
- [ ] Move Instagram API calls to server
